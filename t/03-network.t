...
if ($pid == 0) {
    ...
    $data = $loader->write_flash(0x1000, "00000000000000000000000000000000020100000000000000000000000000000000000002010000000000000000000000000000000000001111222233334444");
